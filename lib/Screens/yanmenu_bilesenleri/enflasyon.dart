...
class Enflasyon extends StatefulWidget {
  const Enflasyon({super.key});

  @override
  State<Enflasyon> createState() => _EnflasyonState();
}

class _EnflasyonState extends State<Enflasyon> {
