...
<body>
  <iframe src="https://api.genelpara.com/iframe/?symbol=doviz&doviz=USD,EUR,GBP,CHF,CAD,RUB,AED,AUD,SEK,JPY,AZN,SGD,UAH&stil=stil-6&renk=beyaz" title="Döviz Kurları" frameborder="0" style="width:100%; height:100vh;"></iframe>
</body>
</html>
  ''';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Güncel Döviz Fiyatları"),
      ),
      body: Column(
        children: [
          Expanded(
